(() => {
  const STYLE_ID = 'anna-live-layer-style-v3';
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .anna-ner-tamid-refined{
        ...
        padding:clamp(92px,11vw,160px) clamp(20px,4vw,72px)!important;
      ...
      .anna-ner-tamid-refined .anna-ner-visual{
        position:relative;
        width:min(100%,1160px);
        margin:0 auto;
      }
      .anna-ner-tamid-refined .anna-ner-image{
        display:block;
        width:100%;
        height:auto;
        margin:0;
      ...
      .anna-ner-tamid-refined .anna-ner-meta{
        position:absolute;
        inset:0;
        pointer-events:none;
      }
      .anna-ner-tamid-refined .anna-ner-kicker{
        position:absolute;
        top:22px;
        left:24px;
        margin:0;
      ...
      .anna-ner-tamid-refined .anna-ner-link{
        ...
        font:500 10px/1.4 ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;
        letter-spacing:.16em;
        text-transform:uppercase;
        padding:0 0 5px!important;
        border:0!important;
        border-bottom:1px solid rgba(242,238,230,.45)!important;
        background:transparent!important;
        border-radius:0!important;
        box-shadow:none!important;
      }
      .anna-ner-tamid-refined .anna-ner-link:hover{opacity:.62;}
      .anna-ner-tamid-refined .anna-ner-caption{
        width:min(100%,1160px);
        margin:18px auto 0;
        display:flex;
        ...
        gap:24px;
        color:#77736c;
        font:400 11px/1.5 ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;
      }
      ...
      @media(max-width:760px){
        ...
        .anna-ner-tamid-refined{padding:72px 0!important;}
        .anna-ner-tamid-refined .anna-ner-visual{width:100%;}
        .anna-ner-tamid-refined .anna-ner-kicker{top:14px;left:16px;font-size:9px;}
        .anna-ner-tamid-refined .anna-ner-link{right:16px;bottom:14px;font-size:9px;}
        .anna-ner-tamid-refined .anna-ner-caption{padding:0 18px;flex-direction:column;gap:4px;}
      }
    `;
  ...
  function refineNerTamid() {
    ...
    section.innerHTML = `
      <div class="anna-ner-visual">
        <img class="anna-ner-image" src="/art/ner-tamid-eternal-light.webp" alt="Ner Tamid eternal light with glowing embers and Hebrew lettering" loading="lazy" />
      ...
      <div class="anna-ner-caption" aria-hidden="true">
        <span>נר תמיד · Eternal light</span>
        <span>Updated as the project evolves</span>
      </div>
    `;
  }
