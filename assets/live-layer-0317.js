  ...
  function refineNerTamid() {
    ...
    section.innerHTML = `
      <div class="anna-ner-visual">
        <img class="anna-ner-image" src="${ASSET_ROOT}/art/ner-tamid-final-0917.webp" alt="Glowing Ner Tamid eternal light with embers and Hebrew lettering" loading="lazy" />
