(() => {
  ...
  const ASSET_ROOT = location.hostname === 'raw.githack.com'
    ? 'https://raw.githack.com/annaraeokay/annaraeart/site-upgrade'
    : '';
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .anna-ner-tamid-refined .anna-ner-visual{position:relative;width:min(100%,1160px);margin:0 auto}
      .anna-ner-tamid-refined .anna-ner-image{display:block;width:100%;height:auto;margin:0;border:0;border-radius:0;box-shadow:none;filter:saturate(.92) contrast(1.025)}
